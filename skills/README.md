...
| [add-semantic-layer](./add-semantic-layer)     | Wire in dbt MetricFlow, Cube, Snowflake views, an in-house YAML semantic layer, or another tool via MCP.                                                                                                                                 | After tests show the agent struggling with metric reliability — not before.                           |
